        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>webuserAddPage"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
					  ...
					  <a class="btn btn-sm btn-info" href="<?php echo base_url().'webuserEditPage/'.$record->id; ?>"><i class="fa fa-pencil"></i></a>
					  <a class="btn btn-sm btn-danger deleteUser" href="#" data-userid="<?php echo $record->id; ?>"><i class="fa fa-trash"></i></a>
					  <a class="btn btn-sm btn-danger" href="<?php echo base_url().'view_detail/'.$record->id;?>">View Detail</a>
                      </td>
                    </tr>
                    <?php
                        }
