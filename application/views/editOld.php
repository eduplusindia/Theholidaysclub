                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>editUser" method="post" id="editUser" role="form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                <?php $locatName = $this->user_model->getActiveLocations();?>
                                    <div class="form-group">
                                        <label for="role">Location</label>
                                        <select class="form-control required" id="locID" name="locID">
                                            <option value="0">Select Location</option>
                                            
                                            <?php foreach($locatName as $val){?> 
                                            <optgroup label="<?php echo $val->locationName;?>">
                                            <?php $vanue = $this->user_model->getActivevenue($val->id);
                                             foreach($vanue as $vanVal){?> 
                                                <option value="<?php echo $vanVal->id;?>" <?php echo ($vanVal->id==$locID)?'Selected':'';?>><?php echo $vanVal->locationName;?></option>
                                                <?php }?>
                                            </optgroup>
                                            <?php }?>
                                        </select>
